 ...
 * {@link @aas-core-works/aas-core3.0rc02-typescript#types.Submodel|Submodel}.
 */
...
export function SubmodelFields(
  props: {
    snapInstance: Readonly<aas.types.Submodel>,
  ...
  return (
    ...
    <widgets.LocalErrors errors={instanceErrors} />
      <fields.ListFieldOptional<aas.types.Extension>
        label="Extensions"
        helpUrl={
          `${help.ROOT_URL}/Submodel.html#property-extensions`
        }
      ...
      <fields.TextFieldOptional
        label="Category"
        helpUrl={
          `${help.ROOT_URL}/Submodel.html#property-category`
        }
      ...
      <fields.TextFieldOptional
        label="Id short"
        helpUrl={
          `${help.ROOT_URL}/Submodel.html#property-id_short`
        }
      ...
      <fields.ListFieldOptional<aas.types.LangString>
        label="Display name"
        helpUrl={
          `${help.ROOT_URL}/Submodel.html#property-display_name`
        }
        parent={props.instance}
      ...
      <fields.ListFieldOptional<aas.types.LangString>
        label="Description"
        helpUrl={
          `${help.ROOT_URL}/Submodel.html#property-description`
        }
        parent={props.instance}
      ...
      <fields.TextFieldOptional
        label="Checksum"
        helpUrl={
          `${help.ROOT_URL}/Submodel.html#property-checksum`
        }
      ...
      <fields.EmbeddedInstanceOptional<aas.types.AdministrativeInformation>
        ...
        helpUrl={
          `${help.ROOT_URL}/Submodel.html#property-administration`
        }
        parent={props.instance}
      ...
      <fields.TextFieldRequired
        label="Id"
        helpUrl={
          `${help.ROOT_URL}/Submodel.html#property-id`
        }
      ...
      <fields.EnumerationFieldOptional
        label="Kind"
        helpUrl={
          `${help.ROOT_URL}/Submodel.html#property-kind`
        }
      ...
      <fields.EmbeddedInstanceOptional<aas.types.Reference>
        label="Semantic id"
        helpUrl={
          `${help.ROOT_URL}/Submodel.html#property-semantic_id`
        }
        parent={props.instance}
        property="semanticId"
        snapInstance={
      ...
      <fields.ListFieldOptional<aas.types.Reference>
        ...
        helpUrl={
          `${help.ROOT_URL}/Submodel.html#property-supplemental_semantic_ids`
        }
        parent={props.instance}
      ...
      <fields.ListFieldOptional<aas.types.Qualifier>
        label="Qualifiers"
        helpUrl={
          `${help.ROOT_URL}/Submodel.html#property-qualifiers`
        }
        parent={props.instance}
        property="qualifiers"
        newInstanceDefinitions={
      ...
      <fields.ListFieldOptional<aas.types.EmbeddedDataSpecification>
        ...
        helpUrl={
          `${help.ROOT_URL}/Submodel.html#property-embedded_data_specifications`
        }
        parent={props.instance}
      ...
      <fields.ListFieldOptional<aas.types.ISubmodelElement>
        label="Submodel elements"
        helpUrl={
          `${help.ROOT_URL}/Submodel.html#property-submodel_elements`
        }
        parent={props.instance}
        property="submodelElements"
        newInstanceDefinitions={
          newinstancing.FOR_SUBMODEL_ELEMENT
        }
        snapItems={
          props.snapInstance.submodelElements
        }
        items={
          props.instance.submodelElements
        }
        setItems={
          (items) => {
            props.instance.submodelElements = items;
          }
        }
      />
    </>
