 ...
 * {@link @aas-core-works/aas-core3.0rc02-typescript#types.Range|Range}.
 */
...
export function RangeFields(
  props: {
    snapInstance: Readonly<aas.types.Range>,
  ...
  return (
    ...
    <widgets.LocalErrors errors={instanceErrors} />
      <fields.ListFieldOptional<aas.types.Extension>
        label="Extensions"
        helpUrl={
          `${help.ROOT_URL}/Range.html#property-extensions`
        }
      ...
      <fields.TextFieldOptional
        label="Category"
        helpUrl={
          `${help.ROOT_URL}/Range.html#property-category`
        }
      ...
      <fields.TextFieldOptional
        label="Id short"
        helpUrl={
          `${help.ROOT_URL}/Range.html#property-id_short`
        }
      ...
      <fields.ListFieldOptional<aas.types.LangString>
        label="Display name"
        helpUrl={
          `${help.ROOT_URL}/Range.html#property-display_name`
        }
        parent={props.instance}
      ...
      <fields.ListFieldOptional<aas.types.LangString>
        label="Description"
        helpUrl={
          `${help.ROOT_URL}/Range.html#property-description`
        }
        parent={props.instance}
      ...
      <fields.TextFieldOptional
        label="Checksum"
        helpUrl={
          `${help.ROOT_URL}/Range.html#property-checksum`
        }
      ...
      <fields.EnumerationFieldOptional
        label="Kind"
        helpUrl={
          `${help.ROOT_URL}/Range.html#property-kind`
        }
      ...
      <fields.EmbeddedInstanceOptional<aas.types.Reference>
        label="Semantic id"
        helpUrl={
          `${help.ROOT_URL}/Range.html#property-semantic_id`
        }
        parent={props.instance}
        property="semanticId"
        snapInstance={
      ...
      <fields.ListFieldOptional<aas.types.Reference>
        ...
        helpUrl={
          `${help.ROOT_URL}/Range.html#property-supplemental_semantic_ids`
        }
        parent={props.instance}
      ...
      <fields.ListFieldOptional<aas.types.Qualifier>
        label="Qualifiers"
        helpUrl={
          `${help.ROOT_URL}/Range.html#property-qualifiers`
        }
        parent={props.instance}
        property="qualifiers"
        newInstanceDefinitions={
      ...
      <fields.ListFieldOptional<aas.types.EmbeddedDataSpecification>
        ...
        helpUrl={
          `${help.ROOT_URL}/Range.html#property-embedded_data_specifications`
        }
        parent={props.instance}
      ...
      <fields.EnumerationFieldRequired
        label="Value type"
        helpUrl={
          `${help.ROOT_URL}/Range.html#property-value_type`
        }
      ...
      <fields.TextFieldOptional
        label="Min"
        helpUrl={
          `${help.ROOT_URL}/Range.html#property-min`
        }
        value={props.snapInstance.min}
        onChange={
          (value) => {
      ...
      <fields.TextFieldOptional
        label="Max"
        helpUrl={
          `${help.ROOT_URL}/Range.html#property-max`
        }
        value={props.snapInstance.max}
        onChange={
          (value) => {
