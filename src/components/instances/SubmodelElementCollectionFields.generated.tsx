 ...
 * {@link @aas-core-works/aas-core3.0rc02-typescript#types.SubmodelElementCollection|SubmodelElementCollection}.
 */
...
export function SubmodelElementCollectionFields(
  props: {
    snapInstance: Readonly<aas.types.SubmodelElementCollection>,
  ...
  return (
    <>
      <fields.ListFieldOptional<aas.types.Extension>
        label="Extensions"
        helpUrl={
          `${help.ROOT_URL}/Submodel_element_collection.html#property-extensions`
        }
      ...
      <fields.TextFieldOptional
        label="Category"
        helpUrl={
          `${help.ROOT_URL}/Submodel_element_collection.html#property-category`
        }
      ...
      <fields.TextFieldOptional
        label="Id short"
        helpUrl={
          `${help.ROOT_URL}/Submodel_element_collection.html#property-id_short`
        }
      ...
      <fields.ListFieldOptional<aas.types.LangString>
        label="Display name"
        helpUrl={
          `${help.ROOT_URL}/Submodel_element_collection.html#property-display_name`
        }
        parent={props.instance}
      ...
      <fields.ListFieldOptional<aas.types.LangString>
        label="Description"
        helpUrl={
          `${help.ROOT_URL}/Submodel_element_collection.html#property-description`
        }
        parent={props.instance}
      ...
      <fields.TextFieldOptional
        label="Checksum"
        helpUrl={
          `${help.ROOT_URL}/Submodel_element_collection.html#property-checksum`
        }
      ...
      <fields.EnumerationFieldOptional
        label="Kind"
        helpUrl={
          `${help.ROOT_URL}/Submodel_element_collection.html#property-kind`
        }
      ...
      <fields.EmbeddedInstanceOptional<aas.types.Reference>
        label="Semantic id"
        helpUrl={
          `${help.ROOT_URL}/Submodel_element_collection.html#property-semantic_id`
        }
        parent={props.instance}
        property="semanticId"
        snapInstance={
      ...
      <fields.ListFieldOptional<aas.types.Reference>
        ...
        helpUrl={
          `${help.ROOT_URL}/Submodel_element_collection.html#property-supplemental_semantic_ids`
        }
        parent={props.instance}
      ...
      <fields.ListFieldOptional<aas.types.Qualifier>
        label="Qualifiers"
        helpUrl={
          `${help.ROOT_URL}/Submodel_element_collection.html#property-qualifiers`
        }
        parent={props.instance}
        property="qualifiers"
        newInstanceDefinitions={
      ...
      <fields.ListFieldOptional<aas.types.EmbeddedDataSpecification>
        ...
        helpUrl={
          `${help.ROOT_URL}/Submodel_element_collection.html#property-embedded_data_specifications`
        }
        parent={props.instance}
      ...
      <fields.ListFieldOptional<aas.types.ISubmodelElement>
        label="Value"
        helpUrl={
          `${help.ROOT_URL}/Submodel_element_collection.html#property-value`
        }
        parent={props.instance}
        property="value"
        newInstanceDefinitions={
