 ...
 * {@link @aas-core-works/aas-core3.0rc02-typescript#types.Capability|Capability}.
 */
...
export function CapabilityFields(
  props: {
    snapInstance: Readonly<aas.types.Capability>,
  ...
  return (
    ...
    <widgets.LocalErrors errors={instanceErrors} />
      <fields.ListFieldOptional<aas.types.Extension>
        label="Extensions"
        helpUrl={
          `${help.ROOT_URL}/Capability.html#property-extensions`
        }
      ...
      <fields.TextFieldOptional
        label="Category"
        helpUrl={
          `${help.ROOT_URL}/Capability.html#property-category`
        }
      ...
      <fields.TextFieldOptional
        label="Id short"
        helpUrl={
          `${help.ROOT_URL}/Capability.html#property-id_short`
        }
      ...
      <fields.ListFieldOptional<aas.types.LangString>
        label="Display name"
        helpUrl={
          `${help.ROOT_URL}/Capability.html#property-display_name`
        }
        parent={props.instance}
      ...
      <fields.ListFieldOptional<aas.types.LangString>
        label="Description"
        helpUrl={
          `${help.ROOT_URL}/Capability.html#property-description`
        }
        parent={props.instance}
      ...
      <fields.TextFieldOptional
        label="Checksum"
        helpUrl={
          `${help.ROOT_URL}/Capability.html#property-checksum`
        }
      ...
      <fields.EnumerationFieldOptional
        label="Kind"
        helpUrl={
          `${help.ROOT_URL}/Capability.html#property-kind`
        }
      ...
      <fields.EmbeddedInstanceOptional<aas.types.Reference>
        label="Semantic id"
        helpUrl={
          `${help.ROOT_URL}/Capability.html#property-semantic_id`
        }
        parent={props.instance}
        property="semanticId"
        snapInstance={
      ...
      <fields.ListFieldOptional<aas.types.Reference>
        ...
        helpUrl={
          `${help.ROOT_URL}/Capability.html#property-supplemental_semantic_ids`
        }
        parent={props.instance}
      ...
      <fields.ListFieldOptional<aas.types.Qualifier>
        label="Qualifiers"
        helpUrl={
          `${help.ROOT_URL}/Capability.html#property-qualifiers`
        }
        parent={props.instance}
        property="qualifiers"
        newInstanceDefinitions={
      ...
      <fields.ListFieldOptional<aas.types.EmbeddedDataSpecification>
        ...
        helpUrl={
          `${help.ROOT_URL}/Capability.html#property-embedded_data_specifications`
        }
        parent={props.instance}
