 ...
 * {@link @aas-core-works/aas-core3.0rc02-typescript#types.AnnotatedRelationshipElement|AnnotatedRelationshipElement}.
 */
...
export function AnnotatedRelationshipElementFields(
  props: {
    snapInstance: Readonly<aas.types.AnnotatedRelationshipElement>,
  ...
  return (
    <>
      <fields.ListFieldOptional<aas.types.Extension>
        label="Extensions"
        helpUrl={
          `${help.ROOT_URL}/Annotated_relationship_element.html#property-extensions`
        }
      ...
      <fields.TextFieldOptional
        label="Category"
        helpUrl={
          `${help.ROOT_URL}/Annotated_relationship_element.html#property-category`
        }
      ...
      <fields.TextFieldOptional
        label="Id short"
        helpUrl={
          `${help.ROOT_URL}/Annotated_relationship_element.html#property-id_short`
        }
      ...
      <fields.ListFieldOptional<aas.types.LangString>
        label="Display name"
        helpUrl={
          `${help.ROOT_URL}/Annotated_relationship_element.html#property-display_name`
        }
        parent={props.instance}
      ...
      <fields.ListFieldOptional<aas.types.LangString>
        label="Description"
        helpUrl={
          `${help.ROOT_URL}/Annotated_relationship_element.html#property-description`
        }
        parent={props.instance}
      ...
      <fields.TextFieldOptional
        label="Checksum"
        helpUrl={
          `${help.ROOT_URL}/Annotated_relationship_element.html#property-checksum`
        }
      ...
      <fields.EnumerationFieldOptional
        label="Kind"
        helpUrl={
          `${help.ROOT_URL}/Annotated_relationship_element.html#property-kind`
        }
      ...
      <fields.EmbeddedInstanceOptional<aas.types.Reference>
        label="Semantic id"
        helpUrl={
          `${help.ROOT_URL}/Annotated_relationship_element.html#property-semantic_id`
        }
        parent={props.instance}
        property="semanticId"
        snapInstance={
      ...
      <fields.ListFieldOptional<aas.types.Reference>
        ...
        helpUrl={
          `${help.ROOT_URL}/Annotated_relationship_element.html#property-supplemental_semantic_ids`
        }
        parent={props.instance}
      ...
      <fields.ListFieldOptional<aas.types.Qualifier>
        label="Qualifiers"
        helpUrl={
          `${help.ROOT_URL}/Annotated_relationship_element.html#property-qualifiers`
        }
        parent={props.instance}
        property="qualifiers"
        newInstanceDefinitions={
      ...
      <fields.ListFieldOptional<aas.types.EmbeddedDataSpecification>
        ...
        helpUrl={
          `${help.ROOT_URL}/Annotated_relationship_element.html#property-embedded_data_specifications`
        }
        parent={props.instance}
      ...
      <fields.EmbeddedInstanceRequired<aas.types.Reference>
        label="First"
        helpUrl={
          `${help.ROOT_URL}/Annotated_relationship_element.html#property-first`
        }
        parent={props.instance}
        property="first"
        snapInstance={
      ...
      <fields.EmbeddedInstanceRequired<aas.types.Reference>
        label="Second"
        helpUrl={
          `${help.ROOT_URL}/Annotated_relationship_element.html#property-second`
        }
        parent={props.instance}
        property="second"
        snapInstance={
      ...
      <fields.ListFieldOptional<aas.types.IDataElement>
        label="Annotations"
        helpUrl={
          `${help.ROOT_URL}/Annotated_relationship_element.html#property-annotations`
        }
        parent={props.instance}
        property="annotations"
        newInstanceDefinitions={
          newinstancing.FOR_DATA_ELEMENT
        }
        snapItems={
          props.snapInstance.annotations
        }
        items={
          props.instance.annotations
        }
        setItems={
          (items) => {
            props.instance.annotations = items;
          }
        }
      />
    </>
