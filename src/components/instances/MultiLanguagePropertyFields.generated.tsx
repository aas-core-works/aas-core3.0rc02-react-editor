 ...
 * {@link @aas-core-works/aas-core3.0rc02-typescript#types.MultiLanguageProperty|MultiLanguageProperty}.
 */
...
export function MultiLanguagePropertyFields(
  props: {
    snapInstance: Readonly<aas.types.MultiLanguageProperty>,
  ...
  return (
    <>
      <fields.ListFieldOptional<aas.types.Extension>
        label="Extensions"
        helpUrl={
          `${help.ROOT_URL}/Multi_language_property.html#property-extensions`
        }
      ...
      <fields.TextFieldOptional
        label="Category"
        helpUrl={
          `${help.ROOT_URL}/Multi_language_property.html#property-category`
        }
      ...
      <fields.TextFieldOptional
        label="Id short"
        helpUrl={
          `${help.ROOT_URL}/Multi_language_property.html#property-id_short`
        }
      ...
      <fields.ListFieldOptional<aas.types.LangString>
        label="Display name"
        helpUrl={
          `${help.ROOT_URL}/Multi_language_property.html#property-display_name`
        }
        parent={props.instance}
      ...
      <fields.ListFieldOptional<aas.types.LangString>
        label="Description"
        helpUrl={
          `${help.ROOT_URL}/Multi_language_property.html#property-description`
        }
        parent={props.instance}
      ...
      <fields.TextFieldOptional
        label="Checksum"
        helpUrl={
          `${help.ROOT_URL}/Multi_language_property.html#property-checksum`
        }
      ...
      <fields.EnumerationFieldOptional
        label="Kind"
        helpUrl={
          `${help.ROOT_URL}/Multi_language_property.html#property-kind`
        }
      ...
      <fields.EmbeddedInstanceOptional<aas.types.Reference>
        label="Semantic id"
        helpUrl={
          `${help.ROOT_URL}/Multi_language_property.html#property-semantic_id`
        }
        parent={props.instance}
        property="semanticId"
        snapInstance={
      ...
      <fields.ListFieldOptional<aas.types.Reference>
        ...
        helpUrl={
          `${help.ROOT_URL}/Multi_language_property.html#property-supplemental_semantic_ids`
        }
        parent={props.instance}
      ...
      <fields.ListFieldOptional<aas.types.Qualifier>
        label="Qualifiers"
        helpUrl={
          `${help.ROOT_URL}/Multi_language_property.html#property-qualifiers`
        }
        parent={props.instance}
        property="qualifiers"
        newInstanceDefinitions={
      ...
      <fields.ListFieldOptional<aas.types.EmbeddedDataSpecification>
        ...
        helpUrl={
          `${help.ROOT_URL}/Multi_language_property.html#property-embedded_data_specifications`
        }
        parent={props.instance}
      ...
      <fields.ListFieldOptional<aas.types.LangString>
        label="Value"
        helpUrl={
          `${help.ROOT_URL}/Multi_language_property.html#property-value`
        }
        parent={props.instance}
        property="value"
        newInstanceDefinitions={
      ...
      <fields.EmbeddedInstanceOptional<aas.types.Reference>
        label="Value id"
        helpUrl={
          `${help.ROOT_URL}/Multi_language_property.html#property-value_id`
        }
        parent={props.instance}
        property="valueId"
        snapInstance={
